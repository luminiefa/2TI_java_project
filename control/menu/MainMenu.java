...
public class MainMenu extends Menu<MainMenu.MainMenuAction> {
	...
	public MainMenu() {
		...
		this.addItem("5", "Exit program", MainMenuAction.EXIT_PROGRAM);
		this.addItem("9", "Object menu", MainMenuAction.EXAMPLE_OBJECT);
	}
	...
	public enum MainMenuAction implements MenuAction {
		...
		LIST, INFO, ADD, DELETE, EXAMPLE_OBJECT, EXIT_PROGRAM
